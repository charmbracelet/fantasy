...
func (a languageModel) Generate(ctx context.Context, call fantasy.Call) (*fantasy.Response, error) {
	...
	response, err := a.client.Messages.New(ctx, *params, append(requestOpts, callUARequestOptions(call)...)...)
	if err != nil {
...
func (a languageModel) Stream(ctx context.Context, call fantasy.Call) (fantasy.StreamResponse, error) {
	...
	stream := a.client.Messages.NewStreaming(ctx, *params, append(requestOpts, callUARequestOptions(call)...)...)
