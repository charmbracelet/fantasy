...
func TestProviderRegistry_AllTypesRegistered(t *testing.T) {
	...
	metadataTests := []struct {
		...
		data         fantasy.ProviderOptionsData
			...
			{"Anthropic Reasoning Metadata", anthropic.Name, &anthropic.ReasoningOptionMetadata{}},		{"Anthropic Web Search Result Metadata", anthropic.Name, &anthropic.WebSearchResultMetadata{}},
